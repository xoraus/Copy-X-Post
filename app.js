...
/**
 * Adds a copy button to tweets in the Twitter UI. The button allows users to copy the tweet text and author handle.
 */
const addCopyButtonToTweets = () => {
  ...
  tweets.forEach((tweet) => {
    ...
    if (bookmarkButton) {
      ...
      // Copy the tweet text when the button is clicked
